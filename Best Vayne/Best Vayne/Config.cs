...
namespace Best_Vayne
{
    public static class Config
    {
        ...
        static Config()
        {
            ...
            Menu.AddLabel("Just a Best Vayne addon, with customizable options.");
